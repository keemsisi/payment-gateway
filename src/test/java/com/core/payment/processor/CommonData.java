...
public final class CommonData {
    ...
    public static Transaction getCardTransactionById(final Long transactionId) throws JsonProcessingException {
    ...
    public static Transaction getGetWalletTransactionById(final Long transactionId) throws JsonProcessingException {
